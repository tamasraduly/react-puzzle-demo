...
class Manual extends Component {
  ...
  render() {
    return (
      ...
      >
        <div id="manualDiv" className="modalDialogContainer">
          <nav
          ...
          <div className="dialogContent">
            ...
            <ul>
              ...
              <li>
                Red font means that the piece is not in the right position
              </li>
              <li>
                Green font means that you should move that piece to get to the
                solution the fastest way. Please note that you need to request
                the solution first.
              </li>
            </ul>
            <h4>Getting Solution</h4>
            If you're stuck or just simply want to know what's the fastest way
            to solve the puzzle, you'll need to follow the steps below:
            <ul>
              <li>
            ...
            Under the puzzle, there's a number showing the total of the
            Manhattan distances of all pieces. Manhattan distance of a piece is
            the sum of the horizontal and vertical steps between its current
            position and the final target position on the puzzle grid.
          </div>
